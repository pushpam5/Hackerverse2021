...
export default function index() {
    return (
        <Card elevation={5} style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <Button icon="record" color="red" uppercase={false} mode="text" style={{ width: '45%', borderRadius: 30 }} onPress={() => { }}>Live</Button>
                <Button color={colors.blue} uppercase={false} mode="outlined" style={{ width: '45%', borderRadius: 30 }} onPress={() => { }}>Join</Button>
            </View>
        </Card>
    )
}
